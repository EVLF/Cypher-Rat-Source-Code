                     ...
                     Try
                         SyncLock sockets.Data.SyncNotifications
                            ...
                            For Each Notice In Me.Items
                                ...
                                sizeText = G.MeasureString(Notice.TEXT, reso.f)
                                ...
                                End If
                                G.DrawString(Notice.TEXT, reso.f, New SolidBrush(ColorFont), sizeFontWidth, Notice.sizeHeight + sizeFontHeight)
...
Public NotInheritable Class Notifications
     ...
     Public sizeHeight As Integer = My.Forms.Report.Height
